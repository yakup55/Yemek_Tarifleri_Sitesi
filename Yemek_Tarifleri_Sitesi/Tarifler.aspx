...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        ...
        <tr __designer:mapid="235">
            ...
            <td class="auto-style20" __designer:mapid="23c">ONAYSIZ TARİFLER LİSTESİ</td>
        </tr>
    </table>
    </p>
                ...
                <table class="auto-style15">
                    <tr>
                        ...
                        <td class="auto-style18">
                            <a href="TariflerAdminDetay.aspx?Tarifid=<%#Eval("Tarifid") %>">  <asp:Image ID="Image2" runat="server" Height="66px" ImageUrl="~/İmage/öneri.jpg" /></a> 
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
    ...
    <p>
        ...
        <tr __designer:mapid="235">
            ...
            <td class="auto-style20" __designer:mapid="23c">ONAYLANMIŞ TARİFLER LİSTESİ</td>
        </tr>
    </table>
        <br />
    </p>
            ...
            <ItemTemplate>
                <table class="auto-style15">
                    <tr>
                        ...
                        <td class="auto-style25">&nbsp;</td>
                        <td class="auto-style18"><a href="TariflerAdminDetay.aspx?Tarifid=<%#Eval("Tarifid") %>">
                            <asp:Image ID="Image3" runat="server" Height="66px" ImageUrl="~/İmage/öneri.jpg" />
                            </a></td>
                    </tr>
                </table>
            </ItemTemplate>
